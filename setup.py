...
config() {
  ...
  docker network connect modern airbyte-proxy
  docker network connect modern airbyte-worker  
  docker network connect modern airflow-airflow-worker-1
  docker network connect modern airflow-airflow-webserver-1
  docker network connect modern
  
  cd airflow
  docker-compose run airflow-webserver airflow connections add 'conexao_airflow_airbyte' --conn-uri 'airbyte://airbyte-proxy:8000'
  cd ..
